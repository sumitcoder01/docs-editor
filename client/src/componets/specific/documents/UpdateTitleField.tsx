...
export const UpdateTitleField = ({ id, title, name = "title", type = "text", placeholder = "document title..", minLength = 5, required = true, toggalShow, setTitle }: UpdateTitleFieldProps) => {
    ...
    return (
        <div className='flex gap-1 md:gap-2 items-center'>
            ...
            <button onClick={toggalShow} className="bg-green-500 hover:bg-green-300  py-2 px-3 mr-1 rounded  text-sm">close</button>
