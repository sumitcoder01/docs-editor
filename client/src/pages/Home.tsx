...
const Home = () => {
  return (
    <div className='min-h-screen bg-gray-100 flex gap-2 overflow-auto'>
      <Navbar />
      <div className="flex flex-col h-full gap-5 mr-2 mt-1 ml-8 sm:ml-5 w-[60%] md:w-auto items-center md:items-start">
